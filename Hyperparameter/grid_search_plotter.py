...
columns = ['Hidden Dimension','Learning Rate','Convolutional Layers', "Execution Time"]
df_time = pd.DataFrame(data=df_data_time, columns=columns)
print(df_time)

fig = px.parallel_coordinates(df_time, color="Execution Time",
                              dimensions=columns,
...
fig = px.parallel_coordinates(df_time, color="CPU Usage",
                              dimensions=columns,
                              color_continuous_scale=px.colors.diverging.RdYlBu_r,
...
fig = px.parallel_coordinates(df_time, color="Memory Usage",
                              dimensions=columns,
                              color_continuous_scale=px.colors.diverging.RdYlBu_r,
