...
fig.tight_layout(rect=[0, 0.03, 1, 0.97])  # Adjust the layout to accommodate the title on top
plt.title(name + ': Accuracy, Learning Rate, and Hidden Dimension vs. Number of Convolutional Layers', loc='center')
