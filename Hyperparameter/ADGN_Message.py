...
def train(dataset, conv_layer, writer,  epochs, lr = 0.01, hidden_layer = 32, anti_symmetric =True):
    ...
    model = ADGN(max(dataset.num_node_features, 1), hidden_layer, dataset.num_classes, num_layers=conv_layer, antisymmetric=anti_symmetric)
